...
#ifdef RES_IN_DLL
	   err = template_load_from_res(csp, &section_template, "edit-actions-list-button", 0);
#else
...
#ifdef RES_IN_DLL
   err = template_load_from_res(csp, &section_template, "edit-actions-list-section", 0);
#else
...
#ifdef RES_IN_DLL
   err = template_load_from_res(csp, &url_template, "edit-actions-list-url", 0);
#else
...
#ifdef RES_IN_DLL
	  err = template_load_from_res(csp, &filter_template, "edit-actions-for-url-filter", 0);
#else
