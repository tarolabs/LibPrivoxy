...
enum privoxy_err
{
   ...
   JB_ERR_DLLMODULE  = 7,   /** Dll module handle is null, maybe not dll not initialized */
   JB_ERR_DLLRES     = 8    /** read resource from dll error */
};

#define TEMPLATES_RES_TYPE "TEMPLATES"
...
struct reusable_connection
{
   ...
   char *gateway_host;
   int  gateway_port;
   /** username for socks proxy ,NULL or empty string as anonymous*/
   char *gateway_username;
   /** password for socks proxy ,NULL or empty string as anonymous*/
...
#ifdef PAC_SCRIPT
   /** user specific pac file , if null the read from dll res */
   const char *pac_file;

   /** the pac rule of user extend. */
   //const char *user_extend_pac_rule_file;
#endif
};
...
/** URL for the sockscap64 */
#define HOME_PAGE_SOCKSCAP64 "https://www.sockscap64.com/"

/** URL for the tarolabs */
#define HOME_PAGE_TAROLABS "http://www.tarolabs.com/"
...
#ifdef PAC_SCRIPT
#define CGI_SITE_3_HOST "127.0.0.1"
#define CGI_SITE_3_PATH "/echo-pac"
#endif
