 ...
 * message to the user).
 */
#define LOG_LEVEL_MINIMUM  LOG_LEVEL_FATAL | LOG_LEVEL_ERROR
#define LOG_LEVEL_ALL LOG_LEVEL_GPC|LOG_LEVEL_CONNECT|LOG_LEVEL_RE_FILTER|LOG_LEVEL_REDIRECTS|LOG_LEVEL_DEANIMATE|LOG_LEVEL_CLF|LOG_LEVEL_CRUNCH|LOG_LEVEL_CGI|LOG_LEVEL_RECEIVED|LOG_LEVEL_ACTIONS|LOG_LEVEL_INFO|LOG_LEVEL_FATAL|LOG_LEVEL_ERROR
