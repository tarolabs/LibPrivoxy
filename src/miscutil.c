...
char * base64_encode(const unsigned char *data, int len)
{
	...
	rv = out = (char *)malloc(((len/3)+1)*4 + 1);
 ...
 *
 * Description :  decode a base64 endcoded string.
 *
 * Parameters  :
 *          1  :  str = data need to decode
 *	        2  :  ret_len = length of return
 *
